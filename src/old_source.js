...
// TODO: display correct answer if it's false
...
var questions = [
    {
        "Lighter brews of coffee have more caffeine than darker brews": [
            "true"
        ]
    },
    {
        "Mercury is warmer than Venus": [
            "false"
        ]
    },
    {
        "Maine is the closest American state to Africa": [
            "true"
        ]
    },
    {
        "Apple once launched a clothing line": [
            "true"
        ]
    },
    {
    ...
    {
        "Koalas usually live up to 40 years": [
            "false"
        ]
    },
    {
    ...
    {
        "Alaska is so big you could fit 100 New Jerseys in it": [
            "false"
        ]
    },
    {
    ...
    {
        "DNA stands for Deoxyribonervous acid": [
            "false"
        ]
    },
    {
        "Dihydrogen Monoxide is poisonous to humans": [
            "false"
        ]
    },
    {
        "Black cats are considered bad luck in Japan": [
            "false"
        ]
    },
    {
        "Nikola Tesla founded Tesla Motors": [
            "false"
        ]
    },
    {
        "A typical cloud weighs around one hundred tons": [
            "false"
        ]
    }
];
...
function getWelcomeResponse(callback) {
    ...
    database.ref('questions').push({
        question: Object.keys(questions[gameQuestions[currentQuestionIndex]])
    }, () => {
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        database.ref('score').set({
            wins: currentScore,
            losses: Math.abs(currentScore - counter),
            gameLength: GAME_LENGTH
        }, () => {
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    database.ref('score').set({
        ...
        callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for learning with Alexa!", "", true));
});
}
